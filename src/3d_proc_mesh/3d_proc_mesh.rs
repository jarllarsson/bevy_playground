// Control a character on the surface of a planet
// Goals:
// 1. Use the 3d mesh game as base, but extend movement to handle any angle on planet surface
// 2. Raytrace to find normals, use for any surface mesh
